...
class Trader:
    ...
    def _trade_ipr(
        ...
        # State carries the first observed ask as anchor for absolute trend level.
        ...
        # Typical day drift from ROUND_1 is around +1000 by end-of-day.
        ...
        # In final ticks, unwind aggressively to lock PnL and avoid end risk.
        ...
        # Core rule from README: build long early and hold.
        if projected_position < limit and remaining_buy > 0:
            # If ask is near or below expected trend level, cross to fill quickly.
            ...
            # Continue working a passive top-up order to reach full long inventory.
            if projected_position < limit and remaining_buy > 0:
        ...
        # Optional tiny maker offer while fully long to monetize temporary spikes.
